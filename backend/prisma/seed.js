...
async function main() {
  console.log('Seeding Phase 3 product & category catalog data...');
  ...
  const productsData = [
    ...
    },
    {
      ...
      description: 'IPX7 waterproof rating with deep bass, 360-degree sound distribution, and 20 hours of continuous continuous playback.',
      price: 149.99,
  ...
  for (const item of productsData) {
    ...
    const existing = await prisma.product.findUnique({ where: { slug: productInfo.slug } });
    if (!existing) {
